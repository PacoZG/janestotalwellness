    ...
    return (
      <div className="flex justify-center items-center outline-none bg-gray-100 min-h-screen md:p-60 p-6">
        <div className="flex flex-col items-center space-x-1">
          ...
          <p className="pr-2 text-center" >Welcome to Jane Total Wellness app, we are working hard to bring the best experience possible for you
          and your journey to a healthy body, mind and soul.</p>
        </div>
      </div>
    )
  }
