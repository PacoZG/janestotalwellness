        ...
        <div className="flex items-center justify-between px-2 pl-4 pr-4 pt-3 md:pt-6 md:pb-5">
          ...
          <div className="hidden md:block">
            <div className="ml-4 flex items-center md:ml-6">
              ...
              <button id="langBackground-button" style={languageBackgroundVisible} onClick={handleLanguageBrackground} className="fixed inset-0 w-full bg-black opacity-25 z-30"></button>
              <div className="ml-3 relative">
                ...
                <button id="background-button" style={backgroundVisible} onClick={handleBrackground} className="fixed inset-0 w-full bg-black opacity-25 z-40"></button>
                <div style={visibleDrop} className="origin-top-right absolute right-0 z-40 mt-2 w-48 rounded-md shadow-lg py-1 bg-white ring-1 ring-black ring-opacity-5 focus:outline-none"
                  ...
                  {loggedUser ?
                    <div>
                      <Link id="profile-button" to="/eng/profile" className="block px-4 py-2 text-sm text-gray-800 hover:bg-gray-100" role="menuitem">Profile</Link>
                      <Link id="editProfile-button" to="/eng/editForm" className="block px-4 py-2 text-sm text-gray-800 hover:bg-gray-100" role="menuitem">Edit profile</Link>
                      <p id="signout-button" onClick={handleLogout} className="block px-4 py-2 text-sm text-gray-800 hover:bg-gray-100 cursor-pointer" role="menuitem" >Sign out</p>
                    </div>
                    :
                    <div>
