  ...
  return (
    <article className="prose prose-red prose-md md:prose-sm mx-auto max-w-4xl p-5 text-justify ">
      ...
      <p>
        ...
        <a href="https://www.termsfeed.com/cookies-policy-generator/" target="blank">
      ...
      <ul>
        <li>
          ...
          &quot;Our&quot; in this Cookies Policy) refers to janestotalwellness.
        </li>
        <li>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            <a href="http://support.microsoft.com/kb/278835" rel="external nofollow noopener" target="blank">
      ...
      <p>
        ...
        <a href="https://www.termsfeed.com/blog/cookies/" target="blank">
