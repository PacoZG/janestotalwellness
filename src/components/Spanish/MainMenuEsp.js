              ...
              <div className="ml-3 relative">
                ...
                <div style={visibleDrop} className="origin-top-right absolute right-0 z-40 mt-2 w-48 rounded-md shadow-lg py-1 bg-white ring-1 ring-black ring-opacity-5 focus:outline-none"
                  ...
                  {loggedUser ?
                    ...
                    :
                    <div>
                      <Link to="/esp/signIn" className="block px-4 py-2 text-sm text-gray-800 hover:bg-gray-100" role="menuitem">Comenzar sesión</Link>
                      <Link to="/esp/signUp" className="block px-4 py-2 text-sm text-gray-800 hover:bg-gray-100" role="menuitem">Subscribirme</Link>
                    </div>
                  }
                </div>
              </div>
        ...
        <div className="flex flex-row relative mt-0 md:hidden pb-2 " id="mobile-menu">
          ...
          <div className="absolute inset-y-0 right-0 border-gray-700">
            ...
            <div style={visibleMobileDrop} className="origin-top-right absolute right-2 z-40 mt-2 w-48 rounded-md shadow-lg py-1 bg-white ring-1 ring-black ring-opacity-5 focus:outline-none"
              ...
              {loggedUser ?
                <div>
                  <Link to="/esp/profile" className="block px-4 py-2 text-md text-gray-800 hover:bg-gray-100" role="menuitem">Perfil</Link>
                  <Link to="/esp/editForm" className="block px-4 py-2 text-md text-gray-800 hover:bg-gray-100" role="menuitem">Editar perfil</Link>
                  <Link to="#" onClick={handleLogout} className="block px-4 py-2 text-md text-gray-800 hover:bg-gray-100" role="menuitem" >Cerrar sesión</Link>
                </div>
                :
                <div>
                  <Link to="/esp/signIn" className="block px-4 py-2 text-md text-gray-800 hover:bg-gray-100" role="menuitem">Comenzar sesión</Link>
                  <Link to="/esp/signUp" className="block px-4 py-2 text-md text-gray-800 hover:bg-gray-100" role="menuitem">Subscribirme</Link>
                </div>
              }
            </div>
          </div>
