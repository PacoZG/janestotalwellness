            ...
            <div className="ml-4 flex items-center md:ml-6">
              <div style={visibleLangMenu}
                ...
                <p id="ENG" className="text-center p-1 hover:bg-gray-500 hover:text-gray-100 cursor-pointer " onClick={() => handleSetLanguage('eng')}>
                  <img src="https://flagcdn.com/40x30/gb.png" className="h-5 w-7" width="80" height="60" alt="Finland" />
                </p>
                ...
                <div style={visibleDrop} className="origin-top-right absolute right-0 z-40 mt-2 w-40 rounded-md shadow-lg py-1 bg-white ring-1 ring-black ring-opacity-5 focus:outline-none"
                  ...
                  {loggedUser ?
                    <div className=" divide-y divide-gray-300 " >
                      <Link to="/esp/profile" className="block text-md text-gray-800 hover:bg-gray-100 p-1" role="menuitem">
                        <div className="flex items-center pl-1">
                          <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5.121 17.804A13.937 13.937 0 0112 16c2.5 0 4.847.655 6.879 1.804M15 10a3 3 0 11-6 0 3 3 0 016 0zm6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                          </svg>
                          <span className="pl-2 text-sm">Perfil</span>
                        </div>
                      </Link>
                      <Link to="/esp/editForm" className="block text-md text-gray-800 hover:bg-gray-100 p-1" role="menuitem">
                        <div className="flex items-center pl-1">
                          <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
                          </svg>
                          <span className="pl-2 text-sm">Editar Perfil</span>
                        </div>
                      </Link>
                      <div onClick={handleLogout} className="block text-md text-gray-800 hover:bg-gray-100 p-1 cursor-pointer" role="menuitem">
                        <div className="flex items-center pl-1">
                          ...
                          <span className="pl-2 text-sm">Cerrar sesión</span>
                        </div>
                      </div>
                    </div>
                    :
                    <div className=" divide-y divide-gray-300">
                      <Link to="/esp/signIn" className="block text-md text-gray-800 hover:bg-gray-100 p-1" role="menuitem">
                        <div className="flex items-center pl-1">
                          <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M11 16l-4-4m0 0l4-4m-4 4h14m-5 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h7a3 3 0 013 3v1" />
                          </svg>
                          <span className="pl-2 text-sm">Iniciar sesión</span>
                        </div>
                      </Link>
                      <Link to="/esp/signUp" className="block text-md text-gray-800 hover:bg-gray-100 pl-1 pt-1 pb-1" role="menuitem">
                        <div className="flex items-center pl-1 ">
                          <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M18 9v3m0 0v3m0-3h3m-3 0h-3m-2-5a4 4 0 11-8 0 4 4 0 018 0zM3 20a6 6 0 0112 0v1H3v-1z" />
                          </svg>
                          <span className="pl-2 text-sm">Subscribirme</span>
                        </div>
                      </Link>
                    </div>
                  }
        ...
        <div className="flex flex-row relative mt-0 md:hidden pb-2 " id="mobile-menu">
          ...
          <div className="absolute inset-y-0 right-0 border-gray-700">
            ...
            <div style={visibleMobileDrop} className="origin-top-right absolute right-2 z-40 mt-2 w-36 rounded-md shadow-lg py-1 bg-white ring-1 ring-black ring-opacity-5 focus:outline-none"
              role="menu" aria-orientation="vertical" aria-labelledby="user-menu" >
              {loggedUser ?
                <div className=" divide-y divide-gray-300 pb-1" >
                  <Link to="/esp/profile" className="block text-md text-gray-800 hover:bg-gray-100 p-1" role="menuitem">
                    <div className="flex items-center pl-1">
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5.121 17.804A13.937 13.937 0 0112 16c2.5 0 4.847.655 6.879 1.804M15 10a3 3 0 11-6 0 3 3 0 016 0zm6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
