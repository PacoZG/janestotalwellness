    ...
    return (
      <div className="flex justify-center items-center outline-none bg-gray-100 min-h-screen md:p-60 p-6">
        <div className="flex flex-col items-center space-x-1">
          ...
          <p className="pr-2 text-center" >Bienvenido a Jane Total Wellness app, estamos trabajando arduamente para brindar la mejor experiencia posible para usted y su viaje hacia un cuerpo, mente y alma saludables.</p>
        </div>
      </div>
    )
  }
