  ...
  const handleClientsInfo = (event) => {
    ...
    if (userUpdated) {
      ...
      dispatch(setNotification({
        message: 'Tu perfil se ha actualizado satisfactoriament.',
        title: 'Sucess',
        show: true
      }))
      userUpdated = false
        ...
        <div className="shadow overflow-hidden rounded-md bg-gradient-to-br from-gray-300 via-white to-gray-300 p-3">
          ...
          <div className="grid grid-cols-6 gap-4 place-items-center border-b pb-3">
            <div className="block col-span-6">
              <p className="text-md">{client.address ? client.address : <span className="text-red-400">La dirección no ha sido proporcionada</span>}</p>
            </div>
            <div className="block col-span-6">
              <p className="text-md ">
                {client.address && client.zipCode && client.city ? `${client.zipCode}, ${client.city}. ${client.country.toUpperCase()}` : <span className="text-red-400">La dirección no ha sido proporcionada</span>}</p>
            </div>
            <div className="block col-span-6">
            ...
            <div className="block col-span-6">
              <p className="text-md"><span className="font-semibold">Número de móbil: </span>
                {client.mobileNumber ? client.mobileNumber : <span className="text-red-400">no ha sido proporcionado</span>}</p>
            </div>
            <div className="block col-span-3 capitalize">
              <p className="text-md"><span className="font-semibold">Género: </span>
                {client.gender}</p>
            </div>
            <div className="block col-span-3">
              <p className="text-md"><span className="font-semibold">Edad: </span>{getAge()} years old</p>
            </div>
            <div className="block col-span-3">
              <p className="text-md"><span className="font-semibold">Altura: </span>{client.height}cm</p>
            </div>
            <div className="block col-span-3">
              <p className="text-md"><span className="font-semibold">Peso: </span>{client.weight}kg</p>
            </div>
            <div className="block col-span-6">
              <p className="text-md"><span className="font-semibold">IMC aproximado: </span>{getBMI()}</p>
            </div>
            <div className="block col-span-6">
              <p className="text-md"><span className="font-semibold">Miembro desde: </span>{getDate(client.createdAt)}</p>
            </div>
          </div>
          ...
          <div className="border-b-2 pb-3">
            <div className="p-3">
              <h2 className="font-semibold text-center">Actualiza medidas biométricas</h2>
              <p className="mt-1 text-xs text-center text-gray-600">El IMC aproximado se calculará automáticamente.</p>
            </div>
          ...
          <div className="border-b-2 pb-2">
            <div className="p-3">
              <h2 className="font-semibold text-center">Nueva nota</h2>
            </div>
          ...
          <p className="text-justify text-gray-400 text-md pb-2 pr-3 pl-3 border-b">
            Para actualizar una nota, escriba en los campos de arriba (título y contenido de la nota) y haga clic en el botón Actualizar en la nota que desea actualizar</p>
          {client.notes.length > 0 ?
            ...
            ) : <h3 className="text-center text-xl font-semibold p-4">No hay notas en el historial de este cliente</h3>}
        </div>
      </div>
        ...
        from-gray-300 via-white to-gray-300 p-3 ">
          <div className="w-screen">
                ...
                <div className="flex-grow pl-10 pt-10">
                  <div className="grid grid-cols-6 gap-4">
                    <div className="col-span-6">
                      <p className="text-md text-left"><span className="text-left font-semibold pr-8">Dirección: </span>
                        {client.address ? client.address : <span className="text-red-400">La dirección no ha sido proporcionada</span>}</p>
                    </div>
                    <div className="col-span-6">
                      <p className="text-md text-left"><span className="text-left font-semibold pr-8">Dirección: </span>
                    ...
                    <div className=" col-span-3">
                      <p className="border-transparent text-left"><span className="text-left font-semibold pr-2">Altura: </span>{client.height}cm</p>
                    </div>
                    <div className=" col-span-3">
                      <p className="border-transparent text-left"><span className="text-left font-semibold pr-2">Peso: </span>{client.weight}kg</p>
                    </div>
                    <div className=" col-span-6">
                      <p className="border-transparent text-left"><span className="text-left font-semibold pr-8">ICM aproximado: </span>{getBMI()}</p>
                    </div>
                    <div className=" col-span-6">
                      <p className="border-transparent text-left"><span className="text-left font-semibold pr-8">Miembro desde: </span>{getDate(client.createdAt)}</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="mr-4 ml-4">
              <div className="grid grid-cols-3 gap-6 shadow-2xl bg-gradient-to-br from-gray-300 via-white to-gray-300
                ...
                <div className="col-span-1">
                  <div className="p-5">
                    <h2 className="text-xl font-medium leading-6 text-gray-900">Actualiza medidas biométricas</h2>
                    <p className="mt-1 text-sm text-gray-600">ICM aproximado se calcula automáticamente.</p>
                  </div>
                </div>
            ...
            <div className="grid grid-cols-3 gap-6 m-4 shadow-2xl bg-gradient-to-br from-gray-300 via-white to-gray-300
              ...
              <div className="col-span-1">
                <div className="p-5">
                  <h2 className="text-xl font-medium text-gray-900">Crea una nota</h2>
                  <p className="mt-1 text-sm text-gray-600">
                    Expresa tus sentimientos y reacciones acerca de la interacción, desempeño o lo que pensamiento generales sobre tus sesiones con este cliente.</p>
                </div>
              </div>
              <div className="m-4 col-span-2 ">
              ...
              <div className="col-span-3">
                ...
                <div className="pl-32 pr-32 pt-4 pb-4">
                  {client.notes.length > 0 ?
                    ...
                    : <h3 className="text-center text-xl font-semibold p-4">No hay notas publicadas en el historial de este cliente.</h3>}
                </div>
              </div>
            </div>
          </div>
