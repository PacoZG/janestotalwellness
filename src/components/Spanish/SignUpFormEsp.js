              ...
              <div className="px-4 py-4 bg-gray-700 md:p-6">
                    ...
                    <div className="mt-8 relative">
                      ...
                      <div id="country" name="country" type="text"
                        ...
                        {country ?
                          ...
                          <div className="opacity-25 text-lg">Selecciona un país</div>}
                ...
                <div className="col-span-6 md:col-span-6">
                  <div className="mt-4 relative">
                    <p className="pl-2  mb-2 text-gray-200" >Metas</p>
                    <textarea className="md:h-40 h-32 block border border-transparent focus:outline-none focus:ring-1 focus:ring-gray-400 focus:border-transparent w-full rounded-md p-2 text-sm placeholder-gray-200" placeholder="Dime porque te gustaría tener mi ayuda"
                  ...
                  <div className="flex items-center space-x-2 pl-2 pt-3">
                    ...
                    <a href="https://www.websitepolicies.com/policies/view/wahdskSn" target='blank' className="text-xs md:text-md text-indigo-400 hover:text-indigo-300">términos</a>
                    <p className="text-xs text-gray-200">y</p>
                    <a href="https://www.websitepolicies.com/policies/view/wahdskSn" target='blank' className="text-xs md:text-md text-indigo-400 hover:text-indigo-300">condiciones</a>
                  </div>
