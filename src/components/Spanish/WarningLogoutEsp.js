...
const WarningLogout = () => {
  ...
  if (loggedUser && UILanguage === 'esp' && loggedUser.userType === 'client') {
        ...
        <div className="relative w-auto my-6 mx-auto max-w-sm">
          <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-gray-50 outline-none focus:outline-none">
            ...
            <div className="relative pl-4 pr-4 pt-4 flex-auto">
              ...
              <p className="my-4 text-blueGray-500 text-lg leading-relaxed">Has iniciado sesión durante 30 minutos, ¿te gustaría quedarte 30 minutos más o cerrar la sesión ahora?</p>
            </div>
