  ...
  return (
    <div className="bg-gray-200 min-h-screen">
      <div className="bg-gray-200 p-2 ">
        ...
        >
          <h3 className=" text-2xl leading-snug tracking-wide uppercase text-center font-bold border-b-2 pb-2 ">
            My clients
          </h3>
              ...
              <li className="flex flex-col items-center space-y-2 md:mt-2 md:mb-5 md:ml-5 md:mr-2 " key={user.id}>
                ...
                >
                  {user.imageURL ? (
                    ...
                    <span className="transform hover:rotate-12 transition duration-500 inline-block rounded-full h-28 w-28 md:h-32 md:w-32  md:rounded-full overflow-hidden bg-gray-100">
