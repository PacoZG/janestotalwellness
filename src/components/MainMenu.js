...
const MainMenu = () => {
  ...
  const languageBackgroundVisible = {
    display: languageBackground ? '' : 'none',
  }
          ...
          <div className="hidden md:block">
            <div className="ml-4 flex items-center md:ml-6">
              ...
              <button
                ...
                style={languageBackgroundVisible}
                onClick={handleLanguageBrackground}
              ...
              <div className="ml-3 relative">
                ...
                <button
                  ...
                  onClick={handleBrackground}
                  className="fixed inset-0 w-full bg-black opacity-25 z-40 cursor-wait"
                ></button>
                <div
                  style={visibleDrop}
                  className="origin-top-right absolute right-0 z-40 mt-2 w-40 rounded-md shadow-lg py-1 bg-white ring-1 ring-black ring-opacity-5 focus:outline-none"
                  role="menu"
          ...
          <div className="absolute inset-y-0 right-0 border-gray-700">
            <div className="flex items-center px-4 right-0">
              ...
              <button
                style={backgroundVisible}
                onClick={handleBrackground}
                className="fixed inset-0 w-full bg-black opacity-25 z-30"
              ></button>
            </div>
            <div
              style={visibleMobileDrop}
