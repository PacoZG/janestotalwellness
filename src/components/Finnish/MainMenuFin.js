          ...
          <div className="hidden md:block">
            <div className="ml-4 flex items-center md:ml-6">
              ...
              shadow-lg py-1 ring-1 ring-black ring-opacity-5 focus:outline-none divide-y divide-gray-500">
                ...
                <p id="FIN" className="text-center p-1 hover:bg-gray-500 hover:text-gray-100 cursor-pointer " >FIN</p>
              ...
              <div className="ml-3 relative">
                ...
                <div style={visibleDrop} className="origin-top-right absolute right-0 z-40 mt-2 w-48 rounded-md shadow-lg py-1 bg-white ring-1 ring-black ring-opacity-5 focus:outline-none"
                  ...
                  {loggedUser ?
                    ...
                    :
                    <div>
                      <Link to="/fin/signIn" className="block px-4 py-2 text-sm text-gray-800 hover:bg-gray-100" role="menuitem">Kirjaudu sisään</Link>
                      <Link to="/fin/signUp" className="block px-4 py-2 text-sm text-gray-800 hover:bg-gray-100" role="menuitem">Kirjaudu</Link>
                    </div>
                  }
                </div>
              </div>
        ...
        <div className="flex flex-row relative mt-0 md:hidden pb-2 " id="mobile-menu">
          ...
          <div className="absolute inset-y-0 right-0 border-gray-700">
            ...
            <div style={visibleMobileDrop} className="origin-top-right absolute right-2 z-40 mt-2 w-48 rounded-md shadow-lg py-1 bg-white ring-1 ring-black ring-opacity-5 focus:outline-none"
              ...
              {loggedUser ?
                <div>
                  <Link to="/fin/profile" className="block px-4 py-2 text-md text-gray-800 hover:bg-gray-100" role="menuitem">Profiili</Link>
                  <Link to="/fin/editForm" className="block px-4 py-2 text-md text-gray-800 hover:bg-gray-100" role="menuitem">Muokkaa profiilia</Link>
                  <Link to="#" onClick={handleLogout} className="block px-4 py-2 text-md text-gray-800 hover:bg-gray-100" role="menuitem" >Kirjaudu ulos</Link>
                </div>
                :
                <div>
                  <Link to="/fin/signIn" className="block px-4 py-2 text-md text-gray-800 hover:bg-gray-100" role="menuitem">Kirjaudu sisään</Link>
                  <Link to="/fin/signUp" className="block px-4 py-2 text-md text-gray-800 hover:bg-gray-100" role="menuitem">Kirjaudu</Link>
                </div>
              }
            </div>
          </div>
