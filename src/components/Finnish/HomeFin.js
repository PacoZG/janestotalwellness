    ...
    return (
      <div className="flex justify-center items-center outline-none bg-gray-100 min-h-screen md:p-60 p-6">
        <div className="flex flex-col items-center space-x-1">
          ...
          <p className="pr-2 text-center" >Tervetuloa Jane Total Wellness app, teemme kovasti töitä saadaksemme parhaan mahdollisen
          kokemuksen sinulle ja matkallesi terveelle ruumiille, mielelle ja sielulle.</p>
        </div>
      </div>
    )
  }
