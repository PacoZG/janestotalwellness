  ...
  const handleClientsInfo = (event) => {
    ...
    if (userUpdated) {
      ...
      dispatch(setNotification({
        message: 'Profiilisi on onnistuneesti päivitetty',
        title: 'Menestys',
        show: true
      }))
      userUpdated = false
  ...
  const handleUpdateNote = async (id) => {
    ...
    if (title.params.value.length > 5 && content.params.value.length > 29) {
      ...
      try {
        ...
        dispatch(setNotification({
          message: 'Huomautus on päivitetty',
          title: 'Menestys',
          show: true
        }))
        title.reset()
    ...
    <div className="bg-gray-200 min-h-screen">
      ...
      <div className="md:hidden flex flex-col">
        <div className="shadow overflow-hidden rounded-md bg-gradient-to-br from-gray-300 via-white to-gray-300 p-3">
          ...
          <div className="grid grid-cols-6 gap-3 place-items-center border-b pb-3 pt-3">
            <div className="block col-span-6">
              <p className="text-md">{client.address ? client.address : <span className="text-red-400">Osoitetta ei ole vielä annettu</span>}</p>
            </div>
            <div className="block col-span-6">
              <p className="text-md ">
                {client.address && client.zipCode && client.city ? `${client.zipCode}, ${client.city}. ${client.country.toUpperCase()}` : <span className="text-red-400">Osoitetta ei ole vielä annettu</span>}</p>
            </div>
            <div className="block col-span-6">
              <p className="text-md"><span className="font-semibold">Sähköposti: </span>
                {client.email}</p>
            </div>
            <div className="block col-span-6">
              <p className="text-md"><span className="font-semibold">Matkapuhelinnumero: </span>
                {client.mobileNumber ? client.mobileNumber : <span className="text-red-400">Ei ole vielä toimitettu</span>}</p>
            </div>
            <div className="block col-span-3 capitalize">
              <p className="text-md"><span className="font-semibold">Sukupuoli: </span>
                {client.gender}</p>
            </div>
            <div className="block col-span-3">
              <p className="text-md"><span className="font-semibold">Ikä: </span>
                {getAge()} vuotta vanha</p>
            </div>
            <div className="block col-span-3">
              <p className="text-md"><span className="font-semibold">Korkeus: </span>{client.height}  cm</p>
            </div>
            <div className="block col-span-3">
              <p className="text-md"><span className="font-semibold">Paino: </span>{client.weight} kg</p>
            </div>
            <div className="block col-span-6">
              <p className="text-md"><span className="font-semibold">Arvioitu BMI: </span>{getBMI()}</p>
            </div>
            <div className="col-start-2 col-span-4 ">
              <label className="col-start-2 font-semibold text-center">Jäsen vuodesta: </label>
            </div>
            <div className="col-span-6">
              <p className="text-md">{getDate(client.createdAt)}</p>
            </div>
          </div>
          <div className="grid grid-cols-6 gap-8 place-items-start border-b p-4" >
            <div className="block col-span-6">
              <label className="text-left font-semibold ">Tausta</label>
          ...
          <div className="border-b-2 pb-3">
            <div className="p-3">
              <h2 className="font-semibold text-center">Päivitä biometriikka</h2>
              <p className="mt-1 text-xs text-center text-gray-600">Arvioitu BMI lasketaan automaattisesti.</p>
            </div>
            <div className="grid grid-cols-6 gap-1 place-items-start border-b ">
              <div className="col-span-3">
                <label className="text-sm font-medium text-gray-700 pl-1">Korkeus</label>
              ...
              <div className="col-span-3">
                <label className="text-sm font-medium text-gray-700 pl-1">Paino</label>
          ...
          <div className="border-b-2 pb-2">
            <div className="p-3">
              <h2 className="font-semibold text-center">Uusi muistiinpano</h2>
            </div>
            <div className="">
              <div className="">
                <label className="block text-sm font-medium text-gray-700 pl-1">Otsikko</label>
          ...
          <h3 className="text-lg text-center font-semibold p-2 pt-3">Huomautuksia</h3>
          <p className="text-justify text-gray-400 text-md pb-2 pr-3 pl-3 border-b ">
            Voit päivittää muistiinpanon kirjoittamalla yllä olevat kentät (muistiinpanon otsikko ja sisältö) ja napsauttamalla Päivitä-painiketta päivitettävässä muistiinpanossa</p>
          {client.notes.length > 0 ?
            client.notes.map(note =>
              <div key={note.id} className="p-2 border rounded-sm shadow-sm mt-2">
                ...
                <p className="text-justify p-2">{note.content}</p>
            ...
            ) : <h3 className="text-center text-xl font-semibold p-4">Tässä asiakashistoriassa ei ole yhtään muistiinpanoa</h3>}
        </div>
      </div>
        ...
        from-gray-300 via-white to-gray-300 p-3 ">
          ...
          <div className="w-screen">
              ...
              <div className="flex p-6 border-b">
                ...
                <div className="flex-grow pl-10 pt-10">
                  <div className="grid grid-cols-6 gap-4">
                    <div className="col-span-6">
                      <p className="text-md text-left"><span className="text-left font-semibold pr-8">Osoite: </span>
                        {client.address ? client.address : <span className="text-red-400">Osoitetta ei ole vielä annettu</span>}</p>
                    </div>
                    <div className="col-span-6">
                      <p className="text-md text-left"><span className="text-left font-semibold pr-8">Osoite: </span>
                    ...
                    <div className=" col-span-3">
                      <p className="border-transparent text-left"><span className="text-left font-semibold pr-2">Korkeus: </span>{client.height}cm</p>
                    </div>
                    <div className=" col-span-3">
                      <p className="border-transparent text-left"><span className="text-left font-semibold pr-2">Piano: </span>{client.weight}kg</p>
                    </div>
                    <div className=" col-span-6">
                      <p className="border-transparent text-left"><span className="text-left font-semibold pr-8">Arvioitu BMI: </span>{getBMI()}</p>
                    </div>
                    <div className=" col-span-6">
                      <p className="border-transparent text-left"><span className="text-left font-semibold pr-8">Jäsen vuodesta: </span>{getDate(client.createdAt)}</p>
                    </div>
                  </div>
                </div>
              </div>
              <div className="pr-16 pl-16 pt-4 pb-4 border-b">
                <label className="text-left font-semibold pr-8">Tausta</label>
            ...
            <div className="mr-4 ml-4">
              <div className="grid grid-cols-3 gap-6 shadow-2xl bg-gradient-to-br from-gray-300 via-white to-gray-300
                ...
                <div className="col-span-1">
                  <div className="p-5">
                    <h2 className="text-xl font-medium leading-6 text-gray-900">Päivitä biometriikka</h2>
                    <p className="mt-1 text-sm text-gray-600">Arvioitu BMI lasketaan automaattisesti.</p>
                  </div>
                </div>
                  ...
                  <div className="shadow overflow-hidden md:rounded-md rounded-b-md">
                    <div className="p-6 bg-transparent">
                      <div className="grid grid-cols-6 gap-3">
                        <div className="col-span-3">
                          <label className="block text-sm font-medium text-gray-700 pl-2">Korkeus</label>
                          <input name="web-height" id="web-height" {...height.params}
                        ...
                        <div className="col-span-3">
                          <label className="block text-sm font-medium text-gray-700 pl-2">Piano</label>
            ...
            <div className="grid grid-cols-3 gap-6 m-4 shadow-2xl bg-gradient-to-br from-gray-300 via-white to-gray-300
              ...
              <div className="m-4 col-span-2 ">
                <div className="shadow overflow-hidden rounded-md rounded-b-md">
                  <div className="p-6 bg-transparent">
                    <div className="grid grid-cols-6 gap-3">
                      <div className="col-span-6">
                        <label className="block text-sm font-medium text-gray-700 pl-2">Otsikko</label>
              ...
              <div className="col-span-3">
                <h3 className="text-center text-xl font-semibold pt-4 pb-2 border-t ">Muistiinpanoja</h3>
                <p className="text-center text-gray-400 text-md pb-2 pl-24 pr-24 border-b">
                  Voit päivittää muistiinpanotyypin yllä olevissa kentissä (Otsikko ja muistiinpanon sisältö)
                  napsauttamalla sitten Päivitä-painiketta muistiinpanossa, jonka haluat päivittää</p>
